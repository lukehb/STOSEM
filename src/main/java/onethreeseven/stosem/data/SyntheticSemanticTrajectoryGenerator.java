package onethreeseven.stosem.data;
...
import onethreeseven.stosem.algorithm.STOSEM;
...
public class SyntheticSemanticTrajectoryGenerator {
     ...
     * @param noise How many noise to the extracted coordinates (in metres).
    ...
    public List<CompositePt<SemanticPlace>> extractPlaces(File osmFile,
        ...
        BiConsumer<Entity, Geometry> placeConsumer = (entity, geometry) -> {
            SemanticPlace place = STOSEM.placeFromOSMEntity(entity, tagFilter);
        ...
        STOSEM.extractPlaces(osmFile, sink);
