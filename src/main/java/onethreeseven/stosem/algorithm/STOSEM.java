...
import onethreeseven.stosem.model.PlaceExtractorSink;
import onethreeseven.stosem.model.StopEpisode;
import onethreeseven.stosem.model.tag.OsmTag;
import onethreeseven.stosem.model.tag.Unknown;
...
import onethreeseven.stosem.model.tag.OsmTagFilter;
...
/**
 * STOSEM builds semantic trajectories from a series of stop-episodes.
 *
...
public class STOSEM {
    ...
    private static final Logger log = Logger.getLogger(STOSEM.class.getSimpleName());
        ...
        return (way, geometry) -> {
            ...
            for (Object region : regions) {
                ...
                if(distToCenter <= (stopRegionBuffer + sr.stopEpisode.getStopRadiusMeters()) ){
                    double pr = STOSEM.this.computeLogPlaceProbability(place, geometry, sr.getStopEpisode(), stopRegionBuffer);
    ...
    public STOSEM setUseWebQueries(boolean useWebQueries) {
